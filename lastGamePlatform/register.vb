...
Public Class register
    ...
    Private Sub btnContinue_Click(sender As Object, e As EventArgs) Handles btnContinue.Click
        ...
        Try
            ...
            cmd = New MySqlCommand("INSERT INTO playerTable(NAME,EMAIL,AGE,GENDER,SCORE)VALUES('" & TextBox1.Text & "','" & TextBox2.Text & "','" & age & "','" & strGender & "','" & ModuleGameManager.universalScore & "')", conn)
            cmd.ExecuteNonQuery()
            MsgBox("1 NEW RECORD")
            finish = True
        Catch ex As Exception
